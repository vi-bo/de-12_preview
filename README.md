...
| **kafka**                                                                                                                                                                                                                         |                                                                                                                                                                               |
| `docker run -it --network=host edenhill/kcat:1.7.1 -b адрес:9092 -C -t имя_топика`                                                                                                                                                | слушаем топик кафки, запущенной через                                                                                                                                         |
| `/opt/kafka_2.13-3.2.3/bin/kafka-topics.sh --create --topic имя_топика --bootstrap-server localhost:9092 --config retention.ms=300000`                                                                                            | создание топика кафки, с помощь кафки, установленной локально на ноде кластера                                                                                                |
|                                                                                                                                                                                                                                   |                                                                                                                                                                               |
| **hdfs / hive / sqoop**                                                                                                                                                                                                           |                                                                                                                                                                               |
...
| `sqoop import --connect jdbc:postgresql://адрес:5432/имя_базы_данных --driver org.postgresql.Driver --password **** --username **** --table имя_таблицы -m 1 --target-dir /user/vi.bo/warehouse/stg_имя_таблицы --as-parquetfile` |                                                                                                                                                                               |
| **clickhouse**                                                                                                                                                                                                                    |                                                                                                                                                                               |
...
| `sudo docker run -p 9000:9090 -v /etc/prometheus/prometheus.yml: /etc/prometheus/prometheus.yml prom/prometheus`                                                                                                                  | запуск из контейнера с заданной конфигурацией (prometheus.yml) на порту 9000 (внутри контейнера работает на 9090, поменялЮ чтобы не конфликтовал с ClickHouse)                |
